      ...
      {homeCategoryList.map((item) => {
        return (
          <li
            ...
            key={item.label}
            className={cn(
              "h-[38px] min-w-fit px-3 flex justify-center items-center border border-transparent rounded-lg bg-[rgba(144,144,144,0.2)] hover:bg-[(144,144,144,0.45)] cursor-pointer",
